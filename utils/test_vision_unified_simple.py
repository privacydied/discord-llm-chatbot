...
try:
    _ua_mod = importlib.import_module("bot.vision.unified_adapter")
    _types_mod = importlib.import_module("bot.vision.types")
    UnifiedVisionAdapter = getattr(_ua_mod, "UnifiedVisionAdapter")
    VisionRequest = getattr(_types_mod, "VisionRequest")
    VisionTask = getattr(_types_mod, "VisionTask")
...
async def test_provider_plugins():
    ...
    TogetherPlugin = getattr(_ua_mod, "TogetherPlugin")
    NovitaPlugin = getattr(_ua_mod, "NovitaPlugin")
