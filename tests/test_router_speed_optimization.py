...
from bot.budget_manager import BudgetManager, BudgetFamily, SoftBudgetExceeded, HardDeadlineExceeded
...
class TestSharedHttpClient:
    ...
    async def test_circuit_breaker(self):
        ...
        async with SharedHttpClient(config) as client:
            ...
            client.set_host_limits("nonexistent.example", HostLimits(
                max_concurrent=1,
            ...
            for i in range(5):
                try:
                    await client.get("https://nonexistent.example/test", 
