...
def test_dm_unknown_command_is_chat(mock_bot, mock_message):
    """Test that an unknown command like !foo is treated as a CHAT command."""
    ...
    assert result.command == Command.CHAT
    assert result.cleaned_content == "!foo bar baz"
