...
class TestConfigReload:
    ...
    def test_compare_configs(self):
        ...
        new_config = {"KEY1": "new_value", "KEY2": "same_value", "KEY4": "added_value"}
        ...
        assert changes["modified"] == {"KEY1": {"old": "old_value", "new": "new_value"}}
    ...
    def test_manual_reload_command_failure(self):
        ...
        with patch("bot.config_reload.reload_env") as mock_reload:
            mock_reload.return_value = {"success": False, "error": "Test error message"}
...
class TestConfigReloadIntegration:
    ...
    def test_get_config_for_debug(self):
        ...
        test_config = {"DISCORD_TOKEN": "secret123", "PUBLIC_SETTING": "public_value"}
