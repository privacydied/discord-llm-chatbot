...
def test_all_failed_url_produces_empty_prompt_no_original_text() -> None:
    ...
    agg.add_result(
        0,
        DummyItem("https://financetwitter.com/some-link"),
        InputModality.GENERAL_URL,
        result_text="Could not extract content",
        success=False,
    )
...
def test_all_failed_item_with_only_whitespace_original_text() -> None:
    ...
    agg.add_result(
        0,
        DummyItem("https://example.com/document"),
