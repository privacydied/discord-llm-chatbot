...
class TestSensitiveDataFilter:
    ...
    def test_redacts_api_keys_in_detail(self, filter_obj):
    ...
    def test_redacts_discord_token(self, filter_obj):
    ...
    def test_redacts_x_bearer_token(self, filter_obj):
    ...
    def test_redacts_nested_secrets(self, filter_obj):
    ...
    def test_handles_missing_detail_gracefully(self, filter_obj):
    ...
    def test_non_dict_detail_passes_through(self, filter_obj):
...
class TestRedactSensitiveValues:
    def test_redacts_api_key_in_text(self, monkeypatch):
    ...
    def test_redacts_discord_token(self, monkeypatch):
    ...
    def test_handles_short_tokens(self, monkeypatch):
...
class TestPublicOutputSanitizer:
    ...
    def test_reasoning_leak_blocked(self):
    ...
    def test_mode_gate_blocked(self):
    ...
    def test_political_discussion_allowed(self):
...
class TestHasReasoningLeakage:
    def test_detects_okay_the_user(self):
    ...
    def test_no_leak_in_normal_text(self):
...
class TestLoggingDoesNotLeakSecrets:
    ...
    def test_reasoning_leak_logged_with_hash_not_content(self, caplog):
    ...
    def test_log_excludes_full_content(self, caplog):
...
class TestPartialSecretRedaction:
    ...
    def test_env_value_redacted_from_arbitrary_key(self):
...
class TestSecretKeysCompleteness:
    ...
    def test_all_secret_envs_in_secret_keys(self):
