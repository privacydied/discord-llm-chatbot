...
class TestVideoCommands:
    ...
    async def test_url_extraction_from_message(self):
        ...
        test_cases = [
            ("Check out this video: https://youtube.com/watch?v=test123", "https://youtube.com/watch?v=test123"),
            ("https://youtu.be/abc123 is amazing!", "https://youtu.be/abc123"),
            ("Look at https://tiktok.com/@user/video/123456789", "https://tiktok.com/@user/video/123456789"),
...
class TestVideoIngestionIntegration:
    ...
    @pytest.mark.asyncio
    @pytest.mark.skipif(not Path("test_videos").exists(), reason="Test videos not available")
    ...
    async def test_cache_behavior(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch('bot.video_ingest.CACHE_DIR', cache_dir):
                ...
                with patch.object(manager, '_download_with_ytdlp') as mock_download, \
