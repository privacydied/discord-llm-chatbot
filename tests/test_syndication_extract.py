...
class TestSyndicationExtract:
    ...
    def test_extract_photos_multiple(self):
        ...
        assert "https://pbs.twimg.com/media/ABC123?format=jpg&name=orig" in result["image_urls"]
    ...
    def test_extract_quoted_only_when_none(self):
        ...
        syndication_json_main_photos = {
            ...
            "photos": [
                {"url": "https://pbs.twimg.com/media/MAIN123?name=small"}
            ],
            "quoted_tweet": {
                "photos": [
    ...
    def test_extract_deduplication(self):
        ...
        syndication_json = {
            ...
            "photos": [
                ...
                {"url": "https://pbs.twimg.com/media/ABC123?name=large"},  # Same base URL
