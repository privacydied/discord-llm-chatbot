...
class TestVisionErrorHandling:
    ...
    async def test_see_infer_user_friendly_messages(self):
        ...
        with patch('bot.see.os.path.exists', return_value=True), \
    ...
    async def test_openai_backend_retry_logic(self):
        ...
        with patch('bot.openai_backend.load_config') as mock_config, \
...
class TestRouterErrorHandling:
    ...
    def test_router_error_message_extraction(self):
        ...
        test_cases = [
            ("temporarily unavailable due to provider issues", "temporarily unavailable"),
