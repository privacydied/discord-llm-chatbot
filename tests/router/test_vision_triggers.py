...
class TestVisionTriggers(unittest.TestCase):
    ...
    def _should_trigger(self, content: str) -> bool:
        ...
        return any(re.search(pattern, content_clean) for pattern in self.trigger_patterns)

    def test_imagine_prose_no_trigger(self) -> None:
        ...
        for content in test_cases:
            with self.subTest(content=content):
                ...
                assert not result, f"'{content}' should NOT trigger T2I"

    def test_explicit_generate_still_works(self) -> None:
        ...
        for content in test_cases:
            with self.subTest(content=content):
                result = self._should_trigger(content)
                assert result, f"'{content}' should trigger T2I"

    def test_explicit_create_still_works(self) -> None:
    ...
    def test_explicit_make_still_works(self) -> None:
    ...
    def test_draw_requires_media_noun(self) -> None:
        ...
        for content in no_trigger_cases:
            with self.subTest(content=content):
                result = self._should_trigger(content)
                assert not result, f"'{content}' should NOT trigger T2I without media noun"
    ...
    def test_render_requires_media_noun(self) -> None:
    ...
    def test_paint_requires_media_noun(self) -> None:
    ...
    def test_case_insensitive_matching(self) -> None:
        ...
        for content in test_cases:
            with self.subTest(content=content):
                result = self._should_trigger(content)
                assert result, f"'{content}' should trigger T2I (case insensitive)"
    ...
    def test_punctuation_tolerance(self) -> None:
        ...
        for content in test_cases:
            with self.subTest(content=content):
                result = self._should_trigger(content)
                assert result, f"'{content}' should trigger T2I despite punctuation"

    def test_no_false_positives_common_phrases(self) -> None:
