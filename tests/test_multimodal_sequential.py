...
def router(mock_bot):
    ...
    flow_overrides = {
        'process_text': AsyncMock(return_value=None)
    }
...
def test_result_aggregator_formatting():
    ...
    aggregator.add_result(0, mock_item1, InputModality.SINGLE_IMAGE, "This is an image of a cat.", True, 1.5, 1)
    aggregator.add_result(1, mock_item2, InputModality.PDF_DOCUMENT, "Document contains technical specs.", True, 2.1, 2)
