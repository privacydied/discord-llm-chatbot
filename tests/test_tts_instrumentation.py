...
class TestTTSInstrumentation(unittest.TestCase):
    ...
    def test_log_tts_generation(self):
        ...
        with patch("logging.Logger.info") as mock_info:
            ...
            self.assertEqual(
                updated_metrics["tts_generation_count"],
                initial_metrics["tts_generation_count"] + 1,
            )
    ...
    def test_log_tts_error(self):
        ...
        with patch("logging.Logger.error") as mock_error:
            ...
            updated_metrics = get_tts_metrics()
            self.assertEqual(
                updated_metrics["tts_generation_errors"],
                initial_metrics["tts_generation_errors"] + 1,
            )
    ...
    def test_log_gibberish_detection(self):
        ...
        with patch("logging.Logger.warning") as mock_warning:
            ...
            updated_metrics = get_tts_metrics()
            self.assertEqual(
                updated_metrics["tts_gibberish_detected"],
                initial_metrics["tts_gibberish_detected"] + 1,
            )
    ...
    def test_log_cache_event(self):
        ...
        with patch("logging.Logger.debug") as mock_debug:
            ...
            updated_metrics = get_tts_metrics()
            self.assertEqual(
                updated_metrics["tts_cache_misses"],
                initial_metrics["tts_cache_misses"] + 1,
            )
