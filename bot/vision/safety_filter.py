...
class VisionSafetyFilter:
    ...
    def _validate_task_specific(self, request: VisionRequest) -> SafetyResult:
        ...
        if request.task in [VisionTask.IMAGE_TO_IMAGE]:
            ...
            deepfake_indicators = [
                "face swap", "celebrity face", "famous person",
                "political figure", "realistic person", "human face"
            ]
    ...
    def _detect_nsfw_content(self, request: VisionRequest) -> List[str]:
        ...
        anatomy_terms = [
            "nude", "naked", "topless", "bottomless", "underwear",
            "lingerie", "bikini", "swimsuit", "revealing", "exposed"
        ]
    ...
    def _get_default_safety_policy(self) -> Dict[str, Any]:
        ...
        return {
            "blocked_keywords": [
                "explicit", "pornographic", "sexual", "nudity",
                "violence", "gore", "blood", "death", "kill",
                "illegal", "drugs", "weapons", "terrorism",
                "hate", "racist", "discrimination"
            ],
            "warning_keywords": [
                "suggestive", "revealing", "provocative",
            ...
            "nsfw_keywords": [
                "nude", "naked", "topless", "sexual", "erotic",
                "pornographic", "explicit", "adult", "mature"
            ],
            "video_restrictions": {
