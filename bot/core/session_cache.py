...
class SessionCache:
    ...
    def get_cache_stats(self) -> Dict[str, Any]:
        ...
        total_entries = (len(self.user_profiles) + len(self.server_contexts) + 
                        len(self.generic_cache))
        
        estimated_memory_kb = sum(
            entry.size_bytes for cache in [self.user_profiles, self.server_contexts, self.generic_cache]
