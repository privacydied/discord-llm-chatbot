...
class CircuitBreakerStats:
    ...
    def record_failure(self):
        ...
        if (self.state == CircuitState.CLOSED and 
            self.failure_count >= PC.OR_BREAKER_FAILURE_WINDOW):
...
class OptimizedOpenRouterClient:
    ...
    def _is_retryable_error(self, error: Exception) -> bool:
        ...
        retryable_patterns = [
            ...
            "provider returned error", "temporary", "rate limit"
        ]
        
        # Non-retryable: auth, client errors
        non_retryable_patterns = [
            "401", "403", "404", "invalid api key", "unauthorized"
        ]
...
async def get_openrouter_client(api_key: str, base_url: str = "https://openrouter.ai/api/v1") -> OptimizedOpenRouterClient:
