...
from bot.tts.errors import SynthesisError, TTSError
...
class TTSManager:
    ...
    async def process(self, action: Any) -> Any:
        ...
        output_format = str(meta.get("tts_output_format") or meta.get("output_format") or "wav")
