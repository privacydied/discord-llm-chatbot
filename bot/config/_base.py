...
def load_config():
    ...
    config = {
        ...
        "CHANGE_NICKNAME": _parse_bool_str(_clean_env_value(os.getenv("CHANGE_NICKNAME")), False),
        ...
        "BOT_SPEAKS_ONLY_WHEN_SPOKEN_TO": _parse_bool_str(_clean_env_value(os.getenv("BOT_SPEAKS_ONLY_WHEN_SPOKEN_TO")), True),
        "REQUIRE_MENTION_IN_GUILDS": _parse_bool_str(_clean_env_value(os.getenv("REQUIRE_MENTION_IN_GUILDS")), True),
        "ALLOW_REPLY_TO_BOT_WITHOUT_MENTION": _parse_bool_str(_clean_env_value(os.getenv("ALLOW_REPLY_TO_BOT_WITHOUT_MENTION")), True),
        "DM_REQUIRE_MENTION": _parse_bool_str(_clean_env_value(os.getenv("DM_REQUIRE_MENTION")), False),
        # Comma-separated list of triggers: dm, mention, reply, bot_threads, owner, command_prefix
        "REPLY_TRIGGERS": [s.strip() for s in os.getenv("REPLY_TRIGGERS", "dm,mention,reply,bot_threads,owner,command_prefix").split(",") if s.strip()],
        ...
        "PERSISTENT_MEMORY_ENABLE": _parse_bool_str(os.getenv("PERSISTENT_MEMORY_ENABLE"), True),
        "PERSISTENT_MEMORY_SQLITE_PATH": os.getenv("PERSISTENT_MEMORY_SQLITE_PATH", "./data/memory.db"),
        "PERSISTENT_MEMORY_CHROMA_PATH": os.getenv("PERSISTENT_MEMORY_CHROMA_PATH", "./chroma_db"),
        "PERSISTENT_MEMORY_CHROMA_COLLECTION": os.getenv("PERSISTENT_MEMORY_CHROMA_COLLECTION", "curated_memories"),
        ...
        "SERVER_ARCHIVE_DB_PATH": os.getenv("SERVER_ARCHIVE_DB_PATH", "./data/server_archive.db"),
        ...
        "SERVER_ARCHIVE_ADMIN_ONLY": _parse_bool_str(_clean_env_value(os.getenv("SERVER_ARCHIVE_ADMIN_ONLY")), True),
        "SERVER_ARCHIVE_SYNC_ON_START": _parse_bool_str(_clean_env_value(os.getenv("SERVER_ARCHIVE_SYNC_ON_START")), True),
        "SERVER_ARCHIVE_LIVE_TAIL": _parse_bool_str(_clean_env_value(os.getenv("SERVER_ARCHIVE_LIVE_TAIL")), True),
        ...
        "SERVER_ARCHIVE_ARCHIVE_BOT_MESSAGES": _parse_bool_str(
            _clean_env_value(os.getenv("SERVER_ARCHIVE_ARCHIVE_BOT_MESSAGES") or os.getenv("SERVER_ARCHIVE_INCLUDE_BOT_MESSAGES")),
            False,
        ),
        ...
        "MEM_MAX_AGE_MIN": _safe_int(os.getenv("MEM_MAX_AGE_MIN"), "240", "MEM_MAX_AGE_MIN"),
        "MEM_FETCH_TIMEOUT_S": _safe_float(os.getenv("MEM_FETCH_TIMEOUT_S"), "5", "MEM_FETCH_TIMEOUT_S"),
        "MEM_LOG_SUBSYS": os.getenv("MEM_LOG_SUBSYS", "mem.ctx"),
        # Thread-tail reply + context collector [CMV][REH]
        "THREAD_CONTEXT_TAIL_COUNT": _safe_int(os.getenv("THREAD_CONTEXT_TAIL_COUNT"), "5", "THREAD_CONTEXT_TAIL_COUNT"),
        ...
        "VOICE_ENABLE_NATIVE": _parse_bool_str(_clean_env_value(os.getenv("VOICE_ENABLE_NATIVE")), False),
        ...
        "VOICE_PUBLISHER_OPUS_BITRATE": os.getenv("VOICE_PUBLISHER_OPUS_BITRATE", "64k"),
        ...
        "DDG_FORCE_HTML": _parse_bool_str(_clean_env_value(os.getenv("DDG_FORCE_HTML")), True),
        ...
        "X_API_ENABLED": _parse_bool_str(_clean_env_value(os.getenv("X_API_ENABLED")), False),
        ...
        # Fallback rules
        "X_API_REQUIRE_API_FOR_TWITTER": _parse_bool_str(_clean_env_value(os.getenv("X_API_REQUIRE_API_FOR_TWITTER")), False),
        "X_API_ALLOW_FALLBACK_ON_5XX": _parse_bool_str(_clean_env_value(os.getenv("X_API_ALLOW_FALLBACK_ON_5XX")), True),
        # X Syndication Tier [CMV]
        # Hardcoded default: enabled unless explicitly disabled
        "X_SYNDICATION_ENABLED": _parse_bool_str(_clean_env_value(os.getenv("X_SYNDICATION_ENABLED")), True),
        # Fast probe: attempt STT on X URLs before API/syndication [CMV][PA]
        "X_TWITTER_STT_PROBE_FIRST": _parse_bool_str(_clean_env_value(os.getenv("X_TWITTER_STT_PROBE_FIRST")), True),
        # Routing: enable photo media to VL analysis path [CMV]
        # Hardcoded default: enabled (route photos to VL)
        "X_API_ROUTE_PHOTOS_TO_VL": _parse_bool_str(_clean_env_value(os.getenv("X_API_ROUTE_PHOTOS_TO_VL")), True),
        ...
        "X_USER_FIELDS": [s.strip() for s in os.getenv("X_USER_FIELDS", "id,name,username,profile_image_url,verified,protected").split(",") if s.strip()],
        "X_POLL_FIELDS": [
            s.strip()
            for s in os.getenv(
                "X_POLL_FIELDS",
        ...
        "X_PLACE_FIELDS": [s.strip() for s in os.getenv("X_PLACE_FIELDS", "full_name,id,country_code,geo,name,place_type").split(",") if s.strip()],
        # Twitter/X thread unroll feature flags [CMV]
        "TWITTER_UNROLL_ENABLED": _parse_bool_str(_clean_env_value(os.getenv("TWITTER_UNROLL_ENABLED")), True),
        "TWITTER_UNROLL_MAX_TWEETS": _safe_int(os.getenv("TWITTER_UNROLL_MAX_TWEETS"), "30", "TWITTER_UNROLL_MAX_TWEETS"),
        "TWITTER_UNROLL_MAX_CHARS": _safe_int(os.getenv("TWITTER_UNROLL_MAX_CHARS"), "6000", "TWITTER_UNROLL_MAX_CHARS"),
        "TWITTER_UNROLL_TIMEOUT_S": _safe_float(os.getenv("TWITTER_UNROLL_TIMEOUT_S"), "15", "TWITTER_UNROLL_TIMEOUT_S"),
        # Routing defaults
        ...
        "STREAMING_ENABLE": _parse_bool_str(_clean_env_value(os.getenv("STREAMING_ENABLE")), True),
        ...
        "STREAMING_ENABLE_TEXT": _parse_bool_str(_clean_env_value(os.getenv("STREAMING_ENABLE_TEXT")), False),
        "STREAMING_ENABLE_SEARCH": _parse_bool_str(_clean_env_value(os.getenv("STREAMING_ENABLE_SEARCH")), False),
        "STREAMING_ENABLE_RAG": _parse_bool_str(_clean_env_value(os.getenv("STREAMING_ENABLE_RAG")), False),
        "STREAMING_ENABLE_MEDIA": _parse_bool_str(_clean_env_value(os.getenv("STREAMING_ENABLE_MEDIA")), True),
        ...
        "VISION_IMAGE_FALLBACK_MODELS": _clean_env_value(os.getenv("VISION_IMAGE_FALLBACK_MODELS") or os.getenv("IMAGE_FALLBACK_MODELS")) or "",
        ...
        "VISION_AUDIT_ENABLED": _parse_bool_str(_clean_env_value(os.getenv("VISION_AUDIT_ENABLED")), True),
        ...
        "VL_NOTES_TIMEOUT_S": _safe_float(os.getenv("VL_NOTES_TIMEOUT_S"), "120.0", "VL_NOTES_TIMEOUT_S"),
        "VISION_PER_ITEM_BUDGET": _safe_float(os.getenv("VISION_PER_ITEM_BUDGET"), "120.0", "VISION_PER_ITEM_BUDGET"),
        "VL_REQUEST_TIMEOUT": _safe_float(os.getenv("VL_REQUEST_TIMEOUT"), "30.0", "VL_REQUEST_TIMEOUT"),
        # Discord integration
        ...
        "VISION_EPHEMERAL_RESPONSES": _parse_bool_str(_clean_env_value(os.getenv("VISION_EPHEMERAL_RESPONSES")), True),
        # Dry run mode for testing routing and cost decisions
        "VISION_DRY_RUN_MODE": _parse_bool_str(_clean_env_value(os.getenv("VISION_DRY_RUN_MODE")), False),
        ...
        "LOG_RATE_LIMIT_WINDOW_S": _safe_int(os.getenv("LOG_RATE_LIMIT_WINDOW_S"), "60", "LOG_RATE_LIMIT_WINDOW_S"),
        ...
        "STT_MULTIMODAL_FALLBACK_ENABLED": _parse_bool_str(_clean_env_value(os.getenv("STT_MULTIMODAL_FALLBACK_ENABLED")), False),
