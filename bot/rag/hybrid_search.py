...
class HybridRAGSearch:
    ...
    def __init__(
        ...
        logger.info(f"[RAG] Hybrid search configured: eager_vector_load={self.config.eager_vector_load}, "
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"✔ Hybrid RAG search system initialized: "
    ...
    async def search(
        ...
        try:
            ...
            logger.debug(f"[RAG] Search completed: type={search_type}, "
            ...
            search_time = (time.time() - search_start) * 1000
            logger.error(f"[RAG] Search failed: type={search_type}, "
